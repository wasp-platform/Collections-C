(module
  ...
  (func $get_node_at (type 6) (param i32 i32 i32) (result i32)
    ...
    local.get 3
    i32.load offset=28)
  (func $link_behind (type 5) (param i32 i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func $list_size (type 4) (param i32) (result i32)
    ...
    i32.load offset=12
    i32.load)
  (func $list_diter_init (type 5) (param i32 i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    i32.load offset=8
    i32.store offset=12)
  (func $list_diter_add (type 0) (param i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    global.set 0
    local.get 1)
  (func $list_diter_next (type 0) (param i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (data (;0;) (i32.const 1024) "a\00b\00c\00d\00e\00f\00g\00h\00x\00y\00")
