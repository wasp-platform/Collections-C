(module
  ...
  (func $list_size (type 4) (param i32) (result i32)
    ...
    i32.load offset=12
    i32.load)
  (func $list_iter_init (type 5) (param i32 i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    i32.load offset=4
    i32.store offset=12)
  (func $list_iter_add (type 0) (param i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    global.set 0
    local.get 1)
  (func $link_after (type 5) (param i32 i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (data (;0;) (i32.const 1024) "a\00b\00c\00d\00e\00f\00g\00h\00i\00x\00")
