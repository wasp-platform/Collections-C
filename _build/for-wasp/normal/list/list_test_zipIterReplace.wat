(module
  ...
  (func $list_index_of (type 5) (param i32 i32 i32 i32) (result i32)
    ...
    global.set 0
    local.get 3)
  (func $list_zip_iter_init (type 6) (param i32 i32 i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    i32.load offset=4
    i32.store offset=20)
  (func $list_zip_iter_next (type 7) (param i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
    ...
    local.get 3
    i32.load offset=28)
  (func $list_zip_iter_replace (type 8) (param i32 i32 i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
