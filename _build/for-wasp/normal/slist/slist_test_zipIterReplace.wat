(module
  ...
  (func $slist_contains (type 0) (param i32 i32) (result i32)
    ...
    local.get 2
    i32.load)
  (func $slist_index_of (type 5) (param i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func $slist_zip_iter_next (type 5) (param i32 i32 i32) (result i32)
    ...
    local.get 3
    i32.load offset=28)
  (func $slist_zip_iter_replace (type 7) (param i32 i32 i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
