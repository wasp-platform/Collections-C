(module
  ...
  (func $slist_add_last (type 0) (param i32 i32) (result i32)
    ...
    global.set 0
    local.get 1)
  (func $unlinkn (type 5) (param i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func $slist_contains (type 0) (param i32 i32) (result i32)
    ...
    local.get 2
    i32.load)
  (func $slist_zip_iter_init (type 6) (param i32 i32 i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    i32.load offset=4
    i32.store offset=16)
  (func $slist_zip_iter_next (type 5) (param i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
    ...
    local.get 3
    i32.load offset=28)
  (func $slist_zip_iter_remove (type 5) (param i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (data (;0;) (i32.const 1024) "a\00b\00c\00d\00e\00f\00g\00h\00i\00\00")
