(module
  ...
  (func $unlinkn_all (type 0) (param i32 i32) (result i32)
    ...
    global.set 0
    local.get 1)
  (func $slist_destroy_cb (type 5) (param i32 i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    i32.add
    global.set 0)
  (func $slist_remove_all_cb (type 0) (param i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func $slist_add_last (type 0) (param i32 i32) (result i32)
    ...
    global.set 0
    local.get 1)
  (func $get_node_at (type 6) (param i32 i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
    ...
    local.get 4
    i32.load offset=28)
  (func $slist_get_at (type 7) (param i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func $slist_size (type 2) (param i32) (result i32)
    ...
    i32.load offset=12
    i32.load)
  (func $slist_copy_deep (type 7) (param i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
    ...
    global.set 0
    local.get 2)
  (func $copy (type 2) (param i32) (result i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
