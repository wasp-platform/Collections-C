(module
  ...
  (func $teardown_tests (type 3)
    ...
    call $deque_destroy)
  (func $pred3 (type 1) (param i32) (result i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func $deque_size (type 1) (param i32) (result i32)
    ...
    i32.load offset=12
    i32.load)
  (func $deque_get_buffer (type 1) (param i32) (result i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    i32.load offset=12
    i32.load offset=16)
  (func $deque_filter (type 5) (param i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
