(module
  ...
  (func $copy_buffer (type 6) (param i32 i32 i32)
    ...
    i32.add
    global.set 0)
  (func $deque_replace_at (type 7) (param i32 i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func $deque_zip_iter_next (type 5) (param i32 i32 i32) (result i32)
    ...
    local.get 3
    i32.load offset=44)
  (func $deque_zip_iter_replace (type 8) (param i32 i32 i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
