(module
  ...
  (func $array_add_at (type 4) (param i32 i32 i32) (result i32)
    ...
    global.set 0
    local.get 2)
  (func $array_get_at (type 4) (param i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func $array_size (type 1) (param i32) (result i32)
    ...
    i32.load offset=12
    i32.load)
  (func $array_iter_init (type 5) (param i32 i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    i32.const 0
    i32.store offset=8)
  (func $array_iter_next (type 0) (param i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    local.get 2
    i32.load offset=12)
  (func $array_iter_add (type 0) (param i32 i32) (result i32)
    (local i32 i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (data (;0;) (i32.const 1024) "a\00b\00c\00d\00N\00")
