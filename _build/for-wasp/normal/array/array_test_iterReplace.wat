(module
  ...
  (func $array_contains (type 0) (param i32 i32) (result i32)
    ...
    local.get 2
    i32.load offset=4)
  (func $array_iter_init (type 6) (param i32 i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func $array_iter_next (type 0) (param i32 i32) (result i32)
    ...
    local.get 2
    i32.load offset=12)
  (func $array_iter_replace (type 5) (param i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (data (;0;) (i32.const 1024) "a\00b\00c\00d\00replacement\00")
