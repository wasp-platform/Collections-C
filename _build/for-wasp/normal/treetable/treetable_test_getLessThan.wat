(module
  ...
  (func $__original_main (type 3) (result i32)
    ...
    i32.const 8
    i32.add
    call $treetable_get_lesser_than
    drop
    local.get 0
    i32.load offset=56
    local.get 0
  ...
  (func $tree_max (type 0) (param i32 i32) (result i32)
    ...
    local.get 2
    i32.load offset=8)
  (func $treetable_get_lesser_than (type 5) (param i32 i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
    ...
    global.set 0
    local.get 2)
  (func $get_predecessor_node (type 0) (param i32 i32) (result i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
